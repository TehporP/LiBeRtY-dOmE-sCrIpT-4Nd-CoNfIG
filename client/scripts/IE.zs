...
recipes.addShaped(<immersiveengineering:metal_decoration0:4> * 2, [[<immersiveengineering:material:8>, <gregtech:meta_tool:6>, <immersiveengineering:material:8>], [<ore:plateIron>, <ore:scaffoldingSteel>, <ore:plateIron>], [<immersiveengineering:material:8>,<gregtech:meta_tool:7>, <immersiveengineering:material:8>]]);


//HEB
recipes.remove(<immersiveengineering:metal_decoration0:5>);
recipes.addShaped(<immersiveengineering:metal_decoration0:5>, [[<ore:plateElectrum>, <gregtech:meta_tool:7>, <ore:plateSteel>], [<immersiveengineering:material:9>, <immersiveengineering:metal_decoration0:4>, <immersiveengineering:material:9>], [<ore:plateSteel>, <gregtech:meta_tool:6>, <ore:plateElectrum>]]);


//REB
recipes.remove(<immersiveengineering:metal_decoration0:3>);
recipes.addShaped(<immersiveengineering:metal_decoration0:3>, [[null, <ore:plateRedAlloy>, <gregtech:meta_tool:7>], [<ore:plateIron>, <immersiveengineering:wooden_decoration:1>, <ore:plateIron>], [ <gregtech:meta_tool:6>, <ore:plateRedAlloy>, null]]);
...
recipes.addShaped(<immersiveengineering:material:8>, [[<ore:plateIron>, <gregtech:meta_tool:7>, <ore:plateIron>], [<gregtech:meta_tool:5>, <ore:plateCopper>, <gregtech:meta_tool:9>], [<ore:plateIron>, <gregtech:meta_tool:11>, <ore:plateIron>]]);
...
recipes.addShaped(<immersiveengineering:metal_device1:2>, [[ <gregtech:meta_tool:6>, <ore:gearIron>, <gregtech:meta_tool:9>], [<immersiveengineering:metal_decoration0>, <ore:stickSteel>, <immersiveengineering:metal_decoration0>], [<immersiveengineering:connector>, <ore:scaffoldingSteel>, <immersiveengineering:connector>]]);

//Generator block
recipes.remove(<immersiveengineering:metal_decoration0:6>);
recipes.addShaped(<immersiveengineering:metal_decoration0:6>, [[<gregtech:meta_tool:9>, <immersiveengineering:wirecoil:1>, null], [<immersiveengineering:connector:2>, <immersiveengineering:metal_device1:2>, <immersiveengineering:connector:2>], [null, <immersiveengineering:wirecoil:1>, <gregtech:meta_tool:6>]]);

//Thermoelectric Generator
recipes.remove(<immersiveengineering:metal_device1:3>);
recipes.addShaped(<immersiveengineering:metal_device1:3>, [[<ore:blockCopper>, <immersiveengineering:connector:2>, <ore:blockCopper>], [<immersiveengineering:metal_device1:6>, <immersiveengineering:metal_decoration0:6>, <immersiveengineering:metal_device1:6>], [<ore:blockCopper>, <immersiveengineering:connector:2>, <ore:blockCopper>]]);
